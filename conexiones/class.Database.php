    ...
    Public static function get_todo_paginado($tabla, $pagina = 1, $por_pagina = 5) {
        ...
        switch ($tabla) {
            ...
            case 'perfiles':
                ...
                break;
            case 'usuarios':
                $sql = "SELECT u.idUsuario, u.idCliente,u.usuario, u.contrasena, u.idPerfil ,p.perfil,c.nombre "
                        . "FROM usuarios u INNER JOIN perfiles p ON p.idPerfil = u.idPerfil"
                        . " INNER JOIN clientes c "
                        . "ON c.idCliente = u.idCliente ORDER BY c.nombre ASC ";
                break;
            case 'tiposervicio':
...
c.idCliente ,e.fechaVenta, i.nombreImagen, i.idImagen FROM equipos e LEFT JOIN clientes c ON c.idCliente = e.idCliente 
